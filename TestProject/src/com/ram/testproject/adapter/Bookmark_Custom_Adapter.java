...
public class Bookmark_Custom_Adapter extends ArrayAdapter<String>{
	...
	public Bookmark_Custom_Adapter(Activity activity,List<String> session_name2, List<String> session_presenter, List<String> session_timings, List<String> session_startdate, List<String> session_enddate) {		
